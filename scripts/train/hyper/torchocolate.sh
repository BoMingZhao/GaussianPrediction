...
CUDA_VISIBLE_DEVICES=1 python train.py -s $source_path \
    ...
    --densify_from_iter 5000 --save_iterations 29998 70000 --checkpoint_iterations 29998 70000 --norm_rotation \
    --densify_until_iter 15000  --opacity_reset_interval 3000000 --max_time $max_time \
