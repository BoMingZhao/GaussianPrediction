...
python utils/prepare/"$datatype"2colmap.py $workdir
...
python utils/prepare/downsample_points.py $workdir/colmap/dense/workspace/fused.ply $workdir/points3D_downsample.ply